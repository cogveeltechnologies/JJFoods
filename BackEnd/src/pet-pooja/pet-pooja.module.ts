...
@Module({
  imports: [MongooseModule.forFeature([{ name: 'Wishlist', schema: WishlistSchema }, { name: 'Feedback', schema: FeedbackSchema }]), forwardRef(() => WishlistModule), forwardRef(() => FeedbackModule)],
